 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Fe;class ze extends Me{static get __EMPTY_NODE(){return Fe}static set __EMPTY_NODE(e){Fe=e}compare(e,t){return A(e.name,t.name)}isDefinedOn(e){throw(0,s.assertionError)("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return Oe.MIN}maxPost(){return new Oe(P,Fe)}makePost(e,t){return(0,s.assert)("string"==typeof e,"KeyIndex indexValue must always be a string."),new Oe(e,Fe)}toString(){return".key"}}const We=new ze;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ct extends Me{extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),r=n.compareTo(i);return 0===r?A(e.name,t.name):r}makePost(e,t){const n=lt(e),i=st.EMPTY_NODE.updateChild(this.indexPath_,n);return new Oe(t,i)}maxPost(){const e=st.EMPTY_NODE.updateChild(this.indexPath_,at);return new Oe(P,e)}toString(){return xe(this.indexPath_,0).join("/")}constructor(e){super(),this.indexPath_=e,(0,s.assert)(!Ce(e)&&".priority"!==ye(e),"Can't create PathIndex with empty path or .priority key")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
